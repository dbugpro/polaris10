...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-slate-950 text-slate-100 font-sans overflow-hidden selection:bg-cyan-500/30">
      ...
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-3 md:px-6 md:py-4 glass-panel z-10 shadow-2xl relative shrink-0">
      ...
      <main className="flex-1 relative overflow-hidden flex flex-col w-full">
            ...
            <div className="max-w-4xl mx-auto pb-4 w-full">
              ...
              {loadingState === LoadingState.THINKING && (
                <div className="flex items-center gap-3 mb-8 animate-pulse px-2">
                   <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-cyan-600/20 border border-cyan-500/30 flex items-center justify-center">
                        <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-cyan-400 rounded-full animate-ping"></div>
                   </div>
                   <span className="text-cyan-500 text-xs md:text-sm font-medium">Polaris is thinking...</span>
                </div>
              )}
        ...
        <div className="p-3 md:p-6 z-10 max-w-4xl mx-auto w-full shrink-0">
          <form onSubmit={handleSubmit} className="relative group">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full bg-slate-900/80 backdrop-blur-md border border-slate-700 text-slate-100 rounded-2xl py-3 pl-11 md:pl-14 pr-11 md:pr-14 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/50 transition-all shadow-lg placeholder:text-slate-500 text-sm md:text-base"
          ...
          <p className="text-center text-slate-600 text-[10px] mt-2 md:mt-3">
